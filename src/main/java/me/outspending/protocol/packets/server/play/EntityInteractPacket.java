...
public record EntityInteractPacket(@NotNull ClientConnection connection, int entityID, int type, float targetX, float targetY, float targetZ, int hand, boolean sneaking) implements ServerPacket {
